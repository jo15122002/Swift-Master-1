...
struct APIResponse: Codable {
    ...
    let slotID: Int
    let stop, stoppedEOS, stoppedLimit, stoppedWord: Bool
    let stoppingWord: String
    let timings: Timings
    let tokensCached, tokensEvaluated, tokensPredicted: Int
    let truncated: Bool
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case stoppingWord = "stopping_word"
        case timings
...
struct GenerationSettings: Codable {
    ...
    let grammar: String
    let ignoreEOS: Bool
    let logitBias: [JSONAny]
    let minP: Double
    let mirostat: Int
    let mirostatEta: Double
    let mirostatTau: Int
    let model: String
    let nCtx, nKeep, nPredict, nProbs: Int
    let penalizeNl: Bool
    let presencePenalty, repeatLastN: Int
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case nProbs = "n_probs"
        case penalizeNl = "penalize_nl"
        case presencePenalty = "presence_penalty"
        case repeatLastN = "repeat_last_n"
        case repeatPenalty = "repeat_penalty"
        case seed, stop, stream, temp
        case tfsZ = "tfs_z"
        case topK = "top_k"
        case topP = "top_p"
